    ...
    <Select {...rest} value={selectValue} onValueChange={handleValueChange}>
      ...
      <SelectContent>
        {options.map((option: SelectOption) => (
          <SelectItem key={option.label} value={option.value?.toString() ?? option.label}>
            {option.label}
          </SelectItem>
        ))}
      </SelectContent>
