    ...
    <div className={"h-[90vh] flex items-center justify-center lg:pb-8"}>
      ...
      >
        ...
        <div className={"grid grid-cols-2 gap-4 w-full max-w-[75%]"}>
          <StatContainer title={"3.9"} subtitle={"Average Rating"} />
          <StatContainer title={"123"} subtitle={"Ratings Count"} />
          <StatContainer title={"31"} subtitle={"Following"} />
          <StatContainer title={"95"} subtitle={"Followers"} />
          <StatContainer title={"12"} subtitle={"Lists"} className={"col-span-2"} />
        </div>
      </div>
    </div>
  );
